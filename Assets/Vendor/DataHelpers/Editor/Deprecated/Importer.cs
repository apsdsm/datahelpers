...
public class Importer<T> {
    ...
    public Importer() 
	{
		...
		copyMethod = GetType().GetMethod("CopyDataToAsset", BindingFlags.NonPublic | BindingFlags.Instance, null, new Type[] { typeof(T), typeof(ImportData) }, null);
    }
    ...
    public void Import(ScriptableObject asset, ImportData readBundle) {
        if (copyMethod != null) 
		{
	...
	public void CopyReadBundleIntoList<TAsset>( ImportData readBundle, ref List<TAsset> list )
	{
